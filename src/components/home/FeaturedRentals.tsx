        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 sm:mb-14 gap-6">
          <div className="space-y-2 max-w-2xl">
            ...
            <p className="text-sm sm:text-base text-[#1A3B34]/80 font-light">
              Unlike typical vacation rentals with cramped quarters or zero resort amenities, our high-floor Tower 2 suites give you 557 sq. ft. of private comfort + 67 sq. ft. private lanais (624 sq. ft. total), Full kitchens, 180° Diamond Head and mountain vistas, and unrestricted access to Oʻahu’s 1-acre recreation deck—with zero mandatory resort fees.
            </p>
          </div>
