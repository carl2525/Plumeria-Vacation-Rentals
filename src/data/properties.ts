...
export const PROPERTIES: Property[] = [
  {
    ...
    houseRules: [
      'Check-in: 2:00 PM / Checkout: 12:00 PM (Noon)',
      'Complimentary garage parking included from check-in through checkout',
      'Early check-in & late checkout available with advance approval (tiered late fees: 1PM $50, 2PM $100, 3PM $150, after 3PM $300)',
      'Direct booking cancellation: 100% refund 14+ days prior, 50% refund 7–13 days prior',
